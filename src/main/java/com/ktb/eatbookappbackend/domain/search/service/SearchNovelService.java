...
public class SearchNovelService {
    ...
    /**
     * 소설 목록을 정확도가 높은 순으로 정렬하고, 페이지네이션된 결과를 생성합니다.
     *
    ...
    /**
     * 소설 목록을 최신 에피소드의 릴리즈 날짜가 최신인 순으로 정렬하고, 날짜가 같으면 정확도가 높은 순으로 정렬합니다.
     *
    ...
    /**
     * 두 소설의 제목과 작가 이름과의 유사도를 비교하여, 검색어와의 정확도에 따라 정렬합니다.
     *
